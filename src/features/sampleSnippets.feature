Feature: Sample Snippets test
    ...
    Scenario: open URL
        ...
        Then  I expect that the url is "https://guinea-pig.webdriver.io/"
        And   I expect that the url is not "https://google.com"

    Scenario: open sub page of weburl
        Given the page url is not "https://guinea-pig.webdriver.io/two.html"
        And   I open the url "https://guinea-pig.webdriver.io/"
        Then  I expect that the url is "https://guinea-pig.webdriver.io/"
        And   I expect that the url is not "https://google.com"
    ...
    Scenario: click on button
        Given I open the url "https://guinea-pig.webdriver.io/"
